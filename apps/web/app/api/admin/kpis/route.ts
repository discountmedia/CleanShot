// apps/web/app/api/admin/kpis/route.ts
// BFF Route Handler — GET /api/admin/kpis
// Gated by isAdmin(session.email). Returns the four headline counters
// the admin dashboard's KPI row renders.
...
export async function GET(request: NextRequest) {
  ...
  const res = await fetch(`${base}/api/v1/admin/kpis`, {
