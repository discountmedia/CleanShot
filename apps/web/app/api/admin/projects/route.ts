// apps/web/app/api/admin/projects/route.ts
// BFF Route Handler — GET /api/admin/projects?user_email=...
// Gated by isAdmin(session.email). Forwards query string to FastAPI.
...
export async function GET(request: NextRequest) {
  ...
  const url = `${base}/api/v1/admin/projects${qs ? `?${qs}` : ""}`;
