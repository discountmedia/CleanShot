...
def analyze_repo(repo_path):
    ...
    phase1_files = {
        'scripts_dir': ['scripts'],  # Move entire scripts directory
        'directories': ['output'],
...
def reorganize_repo(repo_path, dry_run=True):
    ...
    # Move Phase 1 scripts directory
    for scripts_dir in found_files['scripts_dir']:
        src = repo_path / scripts_dir
        dst = phase1_dir / scripts_dir
